/*! For license information please see main.bf58157c.js.LICENSE.txt */
...
`,nx=wr.span`
  padding: 0 8px;
  color: #0f172a;
`;function rx(){var e;const[t,n]=Re(),a=Number(null!==(e=t.get("page"))&&void 0!==e?e:0),[o,i]=(0,r.useState)(Number.isNaN(a)?0:a),[l,s]=(0,r.useState)([]),[c,u]=(0,r.useState)({totalPages:0,number:0,first:!0,last:!0}),[d,f]=(0,r.useState)(!1),[p,h]=(0,r.useState)(null),g=(0,r.useMemo)((()=>({page:o,size:10,sort:"createdAt,DESC"})),[o]);(0,r.useEffect)((()=>{(async()=>{f(!0),h(null);try{var e;const{data:t}=await xh.get("/notices",{params:g});s(null!==(e=t.content)&&void 0!==e?e:[]),u({totalPages:t.totalPages,number:t.number,first:t.first,last:t.last})}catch(Pv){h(Pv)}finally{f(!1)}})()}),[g]),(0,r.useEffect)((()=>{n({page:o})}),[o,n]);const m=e=>{e<0||e>=c.totalPages||i(e)};return(0,qo.jsxs)(Vm,{children:[(0,qo.jsx)(Gm,{children:"\uacf5\uc9c0\uc0ac\ud56d"}),d&&(0,qo.jsx)(Qm,{children:"\ubd88\ub7ec\uc624\ub294 \uc911..."}),p&&(0,qo.jsx)(qm,{children:"\ubaa9\ub85d\uc744 \ubd88\ub7ec\uc624\uc9c0 \ubabb\ud588\uc2b5\ub2c8\ub2e4."}),!d&&0===l.length&&(0,qo.jsx)(Ym,{children:"\ub4f1\ub85d\ub41c \uacf5\uc9c0\uac00 \uc5c6\uc2b5\ub2c8\ub2e4."}),l.length>0&&(0,qo.jsxs)(qo.Fragment,{children:[(0,qo.jsx)(Zm,{children:l.map((e=>{var t;return(0,qo.jsxs)(Xm,{children:[(0,qo.jsx)(Km,{children:(0,qo.jsx)(ze,{to:`/notices/${e.id}`,children:e.title})}),(0,qo.jsx)(Jm,{children:e.authorNickname}),(0,qo.jsxs)(Jm,{children:["\uc870\ud68c ",null!==(t=e.viewCount)&&void 0!==t?t:0]}),(0,qo.jsx)(Jm,{children:new Date(e.createdAt).toLocaleString()})]},e.id)}))}),c.totalPages>1&&(0,qo.jsxs)(ex,{children:[(0,qo.jsx)(tx,{onClick:()=>m(0),disabled:c.first,children:"\u226a"}),(0,qo.jsx)(tx,{onClick:()=>m(o-1),disabled:c.first,children:"\uc774\uc804"}),(0,qo.jsxs)(nx,{children:[o+1," / ",c.totalPages]}),(0,qo.jsx)(tx,{onClick:()=>m(o+1),disabled:c.last,children:"\ub2e4\uc74c"}),(0,qo.jsx)(tx,{onClick:()=>m(c.totalPages-1),disabled:c.last,children:"\u226b"})]})]})]})}const ax=wr.div`
  max-width: 960px;
  margin: 24px auto;
  padding: 0 16px;
`,ox=wr.button`
...
//# sourceMappingURL=main.bf58157c.js.map